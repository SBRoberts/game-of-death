...
export const PATTERNS: readonly Pattern[] = [
  ...
  },
  {
    ...
    cost: 8,
    role: 'guard',
    tip: 'Plant at your border facing the rival — it eats incoming gliders and survives.',
  ...
  },
  {
    ...
    cost: 12,
    role: 'strike',
    tip: 'Heavy mass down an open lane. Breaks fronts and still-life forts — aim with R.',
  ...
  },
  {
    ...
    cost: 14,
    role: 'bomb',
    tip: 'Drop far from home — deep in the rival culture or into the radicals. It erupts for a thousand generations.',
...
export const SPECIAL_PATTERNS: readonly Pattern[] = [
  ...
  },
  {
    ...
    cost: 24,
    role: 'strike',
    tip: 'Costs a fortune, feeds forever: infects an adjacent rival cell every third generation and never defects. Starves alone.',
    cells: [[0, 0]],
    clearance: 0,
    cellType: 2,
  },
  {
    ...
    cost: 10,
    role: 'guard',
    tip: 'Lives like a normal cell, dies like a bomb — every adjacent rival cell lyses with it. Seed it where they must grow.',
    cells: [[0, 0]],
    clearance: 0,
    cellType: 3,
  },
